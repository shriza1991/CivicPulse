...
| **Phase 8** | Policymaker Workspace | `GovernmentQueuePage.tsx` shows issue/case queue rather than Demand Hotspots & Policy Brief workspace. | **INCOMPLETE** | Hotspot map/list UI, cluster demographic enrichment card, priority score breakdown, policy brief generator view. | **Task 8.1: Re-orient Government Workspace to Demand Hotspots** |
